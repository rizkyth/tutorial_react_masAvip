    ...
    <>
      <div className="w-full min-h-screen flex justify-center items-center mx-auto">
        {Object.keys(product).length > 0 && (
          <div className="flex font-sans w-full max-w-xl">
            <div className="flex-none w-48 relative">
              <img src={product.image} className="absolute inset-0 w-full h-auto object-center" loading="lazy" />
            </div>
            <form className="flex-auto w-full p-6">
